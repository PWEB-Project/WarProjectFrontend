      ...
      <template v-slot:top>
        <v-toolbar flat>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.last_name" label="Nume de familie">
                      </v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.first_name" label="Prenume">
                      </v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <model-select :options="roles" v-model="editedItem.roleName" placeholder="Alege rol">
                      </model-select>
                    </v-col>
                  </v-row>
                </v-container>
          ...
          <v-dialog v-model="dialogDelete" max-width="500px">
            <v-card>
              <v-card-title class="headline">Sigur stergeti utilizatorul?</v-card-title>
              <v-card-actions>
                <v-spacer></v-spacer>
